            ...
            <form method="POST" action="{{ route('dashboard.product.update', ['ProductId' => $product->ProductId]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="category-checkbox">
                        <input type="checkbox" id="category_{{ $category->CategoryId }}" name="categories[]" value="{{ $category->CategoryId }}" {{ in_array($category->CategoryId, $product->categories->pluck('CategoryId')->toArray()) ? 'checked' : '' }}>
