                    ...
                    <div class="col-xs-12 col-sm-9">
                        ...
                        <div class="xv-product-slides grid-view products" data-thumbnail="figure .xv-superimage"  data-product=".xv-product-unit">
                            <div class="row">
                                    ...
                                    <div class="xv-product shadow-around">
                                        ...
                                        <div class="xv-product-content">
                                            ...
                                            <ul class="extra-links">
                                                ...
                                                <li><a href="#"><i class="fa fa-exchange"></i>Compare</a></li>                                 <li><a href="#"><i class="fa fa-expand"></i>Expand</a></li>
                                            </ul><!--ul-->
                                ...
                                <div data-pid="xyz607" data-name="Smartphone Apple iPhone 5 64GB" data-category="mobiles" data-price="250" class="xv-product-unit">
                                    <div class="xv-product mb-15 mt-15 shadow-around">
                                        ...
                                        <div class="xv-product-content">
                                            ...
                                            <span class="xv-price">250.000 VNĐ</span>
                                            <a data-qv-tab="#qvt-cart" href="#" class="product-buy flytoQuickView">MUA</a>
                                        </div><!--xv-product-content--><!--xv-product-content-->
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <a class="xv-block text-center" href="#"
                           style="background-image:url('/Duanmautemplate/assets/img/block-img.jpg'); no-repeat">                            <span>Khuyến mãi hàng tuần</span>
                        </a>
                    </div><!--left column-->

                    <div class="col-xs-12 col-md-6">
                        <a class="xv-block text-center" href="#"
                           style="background-image:url('/Duanmautemplate/assets/img/block-img2.jpg'); no-repeat">                            <span>Combo giảm giá </span>
                        </a>
                    </div><!--right column-->
                </div><!--row-->
            </div><!--customBlock-->
