                                ...
                                <div class="accordian-pane">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            ...
                                            <label>Số điện thoại:</label>
                                            <input type="text" name="phoneget">
                                            <label>Địa chỉ nhận hàng:</label>
                                            <input type="text" name="addressget">
                                            <button class="btn btn-send btn-blue" type="submit">Tiếp tục</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="accordian-pane">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            ...
                                            <label><input type="radio" name="payment_method" value="1">Thanh toán tiền mặt khi nhận hàng</label>
                                            <label><input type="radio" name="payment_method" value="2">Thanh toán bằng thẻ ATM nội địa (Qua VNPay)</label>
                                            <label><input type="radio" name="payment_method" value="3">Thanh toán bằng thẻ quốc tế Visa, Master, JCB</label>
